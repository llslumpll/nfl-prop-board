...
def best5_yardage(rows: list[dict], pp_props: dict, stat_col: str, unit: str) -> list[dict]:
    ...
    for r in rows:
        ...
        candidates.append({
            ...
            "unit": unit,
            "reason": dataio.enhance_reason_with_track_record(dataio.reason_text(projection, STAT_LABELS.get(stat_col, stat_col), row=r), r),
            ...
            "opponent_history": projection.get("opponent_history"),
            "calibration_bias": projection.get("calibration_bias"),
            "calibration_sample_size": projection.get("calibration_sample_size"),
            "line_movement": projection.get("line_movement"),
